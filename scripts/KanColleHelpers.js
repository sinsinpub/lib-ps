...
(function(exports) {
  ...
  var Control_Bind = PS["Control.Bind"];
  var Data_Unfoldable = PS["Data.Unfoldable"];        
  var unsafeArrTail = Data_Array_Partial.tail();
  var unsafeArrIndex = Data_Array.unsafeIndex();
  var unsafeArrHead = Data_Array_Partial.head();
              ...
              var f = function (__copy_x) {
                  return function (__copy_y) {
                      ...
                      tco: while (true) {
                          ...
                          if (Data_Boolean.otherwise) {
                              return g(Data_Semigroup.append(dictSemigroup)(x)(x))((y - 1 | 0) / 2 | 0)(x);
                          };
  ...
  var times = function (dictMonoid) {
      return function (v) {
          return function (v1) {
              ...
              return times1p(dictMonoid["__superclass_Data.Semigroup.Semigroup_0"]())(v - 1 | 0)(v1);
          };
      };
  };
  ...
  var fleetSplit = function (cutHead) {
      return function (xs) {
          var ys = (function () {
              if (cutHead) {
                  return Data_Array_Partial.tail()(xs);
              };
              if (!cutHead) {
                  return xs;
              };
              ...
              return function (v1) {
                  ...
                  return Control_Bind.bind(Data_List_Types.bindList)(tails(v))(function (v2) {
                      ...
                      if (v2 instanceof Data_List_Types.Cons) {
                          return Control_Bind.bind(Data_List_Types.bindList)(pickFrom(v2.value1)(v1 - 1 | 0))(function (v3) {
...
(function(exports) {
  ...
  var applyDameCon = function (dc) {
      return function (s) {
          var s1 = (function () {
              ...
              $10.sunk = false;
              $10.dameCon = Data_Maybe.Nothing.value;
              return $10;
          })();
          if (dc instanceof KanColle_DamageAnalysis_Types.RepairTeam) {
              var $14 = {};
              for (var $15 in s1) {
                  if ({}.hasOwnProperty.call(s1, $15)) {
                      $14[$15] = s1[$15];
                  };
              };
              $14.hp = Data_Int.floor(0.2 * Data_Int.toNumber(s.fullHp));
              return $14;
          };
          if (dc instanceof KanColle_DamageAnalysis_Types.RepairGoddess) {
              var $17 = {};
              for (var $18 in s1) {
                  if ({}.hasOwnProperty.call(s1, $18)) {
                      $17[$18] = s1[$18];
                  };
              };
              $17.hp = s.fullHp;
  ...
  var mkDamage = function (v) {
      ...
      return function ($27) {
          return tryDameCon(applyDamageNum(v)($27));
      };
  };
  ...
  var damageToInt = function (dmg) {
      ...
      return dummyShip.hp - afterShip.hp | 0;
  };
...
(function(exports) {
  ...
  var ensureHpsLen = function (expectLen) {
      return function (xs) {
          ...
          var $38 = Data_Ord.compare(Data_Ord.ordInt)(expectLen)(actualLen);
          if ($38 instanceof Data_Ordering.LT) {
              return KanColle_Util.throwWith("ensureHpsLen: array length is longer than expected");
          };
          if ($38 instanceof Data_Ordering.EQ) {
              return xs;
          };
          if ($38 instanceof Data_Ordering.GT) {
              return Data_Semigroup.append(Data_Semigroup.semigroupArray)(xs)(Data_Array.replicate(expectLen - actualLen | 0)(Data_Maybe.Nothing.value));
          };
          throw new Error("Failed pattern match at KanColle.DamageAnalysis.DamageAnalysis line 45, column 29 - line 48, column 60: " + [ $38.constructor.name ]);
      };
  };
  ...
  var analyzeBothCombinedNightBattle = function (ds) {
      return function (b) {
          ...
          var enemySplitted = (function () {
              var $79 = KanColle_KCAPI_Battle.getEnemyActiveDeck(b);
              if ($79 === 1) {
          ...
          var allFinalFleet = (function () {
              var $80 = KanColle_KCAPI_Battle.getEnemyActiveDeck(b);
              if ($80 === 1) {
                  return {
  ...
  var analyzeAbyssalCTFNightBattle = function (ds) {
      return function (b) {
          ...
          var enemySplitted = (function () {
              var $81 = KanColle_KCAPI_Battle.getEnemyActiveDeck(b);
              if ($81 === 1) {
                  return new Data_Tuple.Tuple(allInitFleet.enemyMain, allInitFleet.enemyEscort);
              };
              if ($81 === 2) {
          ...
          var finalFleet = KanColle_DamageAnalysis_DamageVector.applyNormalDamageVector(resultDV)(initFleet);
          var allFinalFleet = (function () {
              var $82 = KanColle_KCAPI_Battle.getEnemyActiveDeck(b);
              if ($82 === 1) {
                  return {
...
(function(exports) {
  ...
  var fromRawShip = function (s) {
      var $3 = {};
      for (var $4 in s) {
          if ({}.hasOwnProperty.call(s, $4)) {
              $3[$4] = s[$4];
          };
      };
      $3.stype = KanColle_Generated_SType.readSType(s.stype);
      return $3;
  };
  ...
  var checkFleet = function (req) {
      return function (fleet) {
          var count = function (pred) {
              return function ($32) {
                  return Data_Array.length(Data_Array.filter(pred)($32));
              };
          };
          var $20 = Data_Array.uncons(fleet);
          if ($20 instanceof Data_Maybe.Just) {
              if (req instanceof Flagship) {
                  return checkShip(req.value0)($20.value0.head);
              };
          ...
          throw new Error("Failed pattern match at KanColle.Expedition.Requirement line 73, column 24 - line 81, column 21: " + [ $20.constructor.name ]);
      };
  };
...
(function(exports) {
  ...
  var pprFleetNotes = function (xs) {
      ...
      var $7 = Data_Array["null"](notes);
      if ($7) {
          return "<N/A>";
      };
      if (!$7) {
          var formatNote = function (note) {
              return "{" + (Data_Array_Partial.head()(note) + ("}x" + Data_Show.show(Data_Show.showInt)(Data_Array.length(note))));
          };
          var convert = function (v) {
      ...
      throw new Error("Failed pattern match at KanColle.Expedition.Minimal line 198, column 20 - line 204, column 41: " + [ $7.constructor.name ]);
  };
  ...
  var ssCost = function (n) {
      ...
      return Data_Semigroup.append(eCostSemigroup)(maruyu)(KanColle_Util.times(eCostMonoid)(n - 1 | 0)(nonSSV));
  };
  var fillSS = function (n) {
      return function (v) {
          ...
          if (!$20) {
              return Data_Semigroup.append(eCostSemigroup)(v)(ssCost(n - l | 0));
          };
          throw new Error("Failed pattern match at KanColle.Expedition.Minimal line 142, column 25 - line 144, column 27: " + [ $20.constructor.name ]);
      };
  };
  ...
  var cvlCost = function (n) {
      ...
      return Data_Semigroup.append(eCostSemigroup)(houshou)(KanColle_Util.times(eCostMonoid)(n - 1 | 0)(shouhou));
  };
  var clCost = function (n) {
      ...
      if (!$22) {
          return Data_Semigroup.append(eCostSemigroup)(KanColle_Util.times(eCostMonoid)(2)(tenryuu))(KanColle_Util.times(eCostMonoid)(n - 2 | 0)(kuma));
      };
      throw new Error("Failed pattern match at KanColle.Expedition.Minimal line 125, column 12 - line 127, column 45: " + [ $22.constructor.name ]);
  };
  ...
  var avCost = function (n) {
      ...
      throw new Error("Failed pattern match at KanColle.Expedition.Minimal line 100, column 12 - line 105, column 45: " + [ $23.constructor.name ]);
  };
      ...
      return function (iv) {
          return function (v) {
              ...
              return KanColle_Expedition_IncomeBase.mkIncomeBase({
                  fuel: i.fuel - Data_Foldable.sum(Data_Foldable.foldableArray)(Data_Semiring.semiringInt)(fuelCosts) | 0, 
                  ammo: i.ammo - Data_Foldable.sum(Data_Foldable.foldableArray)(Data_Semiring.semiringInt)(ammoCosts) | 0, 
                  steel: i.steel, 
                  bauxite: i.bauxite
              });
          };
  ...
  var sortWithAfkTime = function (evalCost) {
      return function (timePenalty) {
          return function (afkMinutes) {
              ...
              var collectInfo = function (eId) {
                  var cost = KanColle_Expedition_Cost.getExpeditionCost(eId);
                  var timeDiffPenalty = timePenalty * Data_Int.toNumber(ordMax(Data_Ord.ordInt)(0)(cost.time - afkMinutes | 0));
...
(function(exports) {
  ...
  var mkEA = function (xs) {
      ...
      if (Data_Boolean.otherwise) {
          return Partial.crash()("expecting exactly 40 elements");
      };
  ...
  var indEA = function (v) {
      return function (i) {
          ...
          if (Data_Boolean.otherwise) {
              return Partial.crash()("index out of range");
          };
  ...
  var minimumCompositions = (function () {
      ...
      var atLeast = function (n) {
          return function (compo) {
              ...
              if ($0) {
                  return Data_Semigroup.append(Data_Semigroup.semigroupArray)(compo)(Data_Unfoldable.replicate(Data_Unfoldable.unfoldableArray)(n - Data_Array.length(compo) | 0)(Data_Maybe.Nothing.value));
              };
              if (!$0) {
                  return compo;
              };
      ...
      var ssLikeCost = function (n) {
          ...
          if (n <= 6) {
              return Control_Bind.bind(Data_Maybe.bindMaybe)(ssLikeCost(1))(function (v) {
                  return new Data_Maybe.Just(Data_Semigroup.append(Data_Semigroup.semigroupArray)(v)(Data_Unfoldable.replicate(Data_Unfoldable.unfoldableArray)(n - 1 | 0)(KanColle_Expedition_New_Types.mkMC(10)(20))));
              });
          };
          if (Data_Boolean.otherwise) {
              return Data_Maybe.Nothing.value;
      ...
      var cvlLikeCost = function (n) {
          ...
          if (n <= 2) {
              return Control_Bind.bind(Data_Maybe.bindMaybe)(cvlLikeCost(1))(function (v) {
                  return new Data_Maybe.Just(Data_Semigroup.append(Data_Semigroup.semigroupArray)(v)(Data_Unfoldable.replicate(Data_Unfoldable.unfoldableArray)(n - 1 | 0)(KanColle_Expedition_New_Types.mkMC(35)(40))));
              });
          };
          if (n <= 4) {
              return Control_Bind.bind(Data_Maybe.bindMaybe)(cvlLikeCost(2))(function (v) {
                  return new Data_Maybe.Just(Data_Semigroup.append(Data_Semigroup.semigroupArray)(v)(Data_Unfoldable.replicate(Data_Unfoldable.unfoldableArray)(n - 2 | 0)(KanColle_Expedition_New_Types.mkMC(35)(45))));
              });
          };
          if (n <= 6) {
              return Control_Bind.bind(Data_Maybe.bindMaybe)(cvlLikeCost(4))(function (v) {
                  return new Data_Maybe.Just(Data_Semigroup.append(Data_Semigroup.semigroupArray)(v)(Data_Unfoldable.replicate(Data_Unfoldable.unfoldableArray)(n - 4 | 0)(KanColle_Expedition_New_Types.mkMC(40)(40))));
              });
          };
          if (Data_Boolean.otherwise) {
              return Data_Maybe.Nothing.value;
      ...
      var clCost = function (n) {
          ...
          if (n <= 6) {
              return Control_Bind.bind(Data_Maybe.bindMaybe)(clCost(2))(function (v) {
                  return new Data_Maybe.Just(Data_Semigroup.append(Data_Semigroup.semigroupArray)(v)(Data_Unfoldable.replicate(Data_Unfoldable.unfoldableArray)(n - 2 | 0)(KanColle_Expedition_New_Types.mkMC(25)(30))));
              });
          };
          if (Data_Boolean.otherwise) {
              return Data_Maybe.Nothing.value;
      ...
      var caCost = function (n) {
          ...
          if (n <= 4) {
              return Control_Bind.bind(Data_Maybe.bindMaybe)(caCost(1))(function (v) {
                  return new Data_Maybe.Just(Data_Semigroup.append(Data_Semigroup.semigroupArray)(v)(Data_Unfoldable.replicate(Data_Unfoldable.unfoldableArray)(n - 1 | 0)(KanColle_Expedition_New_Types.mkMC(35)(65))));
              });
          };
          if (n <= 6) {
              return Control_Bind.bind(Data_Maybe.bindMaybe)(caCost(4))(function (v) {
                  return new Data_Maybe.Just(Data_Semigroup.append(Data_Semigroup.semigroupArray)(v)(Data_Unfoldable.replicate(Data_Unfoldable.unfoldableArray)(n - 4 | 0)(KanColle_Expedition_New_Types.mkMC(40)(70))));
              });
          };
          if (Data_Boolean.otherwise) {
              return Data_Maybe.Nothing.value;
      ...
      var bbvCost = function (n) {
          ...
          if (n <= 4) {
              return Control_Bind.bind(Data_Maybe.bindMaybe)(bbvCost(2))(function (v) {
                  return new Data_Maybe.Just(Data_Semigroup.append(Data_Semigroup.semigroupArray)(v)(Data_Unfoldable.replicate(Data_Unfoldable.unfoldableArray)(n - 2 | 0)(KanColle_Expedition_New_Types.mkMC(105)(140))));
              });
          };
          if (Data_Boolean.otherwise) {
              return Data_Maybe.Nothing.value;
...
(function(exports) {
  ...
  var calcFleetNetIncome = function (v) {
      return function (v1) {
          return {
              fuel: v.fuel - v1.fuel | 0, 
              ammo: v.ammo - v1.ammo | 0, 
              steel: v.steel, 
              bauxite: v.bauxite
          };
      };
...
(function(exports) {
  ...
  var convertRawInfo = function (ri) {
      var convertRawItem = function (ar) {
          var $2 = Data_Array.unsafeIndex()(ar)(0);
          if ($2 === 0) {
              return Data_Maybe.Nothing.value;
          };
          return new Data_Maybe.Just({
              item: KanColle_Expedition_New_Item.itemFromInt($2), 
              maxCount: Data_Array.unsafeIndex()(ar)(1)
          });
      };
      return {
          id: ri.api_id, 
...
(function(exports) {
  ...
  var resultPackToObject = function (rp) {
      var $10 = {};
      for (var $11 in rp) {
          if ({}.hasOwnProperty.call(rp, $11)) {
              $10[$11] = rp[$11];
          };
      };
      $10.flagShipTypeOf = Data_Nullable.toNullable(rp.flagShipTypeOf);
      $10.levelCount = Data_Nullable.toNullable(rp.levelCount);
      $10.drumCount = Data_Nullable.toNullable(rp.drumCount);
      $10.drumCarrierCount = Data_Nullable.toNullable(rp.drumCarrierCount);
      return $10;
  };
          ...
          return function (fleetReq) {
              if (fleetReq instanceof KanColle_Expedition_Requirement.Flagship) {
                  if (fleetReq.value0 instanceof KanColle_Expedition_Requirement.ShipLevel) {
                      var $15 = {};
                      for (var $16 in p) {
                          if ({}.hasOwnProperty.call(p, $16)) {
                              $15[$16] = p[$16];
                          };
                      };
                      $15.flagShipLevel = fleetReq.value0.value0;
                      return $15;
                  };
                  if (fleetReq.value0 instanceof KanColle_Expedition_Requirement.ShipTypeOneOf) {
                      var $19 = {};
                      for (var $20 in p) {
                          if ({}.hasOwnProperty.call(p, $20)) {
                              $19[$20] = p[$20];
                          };
                      };
                      $19.flagShipTypeOf = new Data_Maybe.Just(fleetReq.value0.value0);
                      return $19;
                  };
              ...
              if (fleetReq instanceof KanColle_Expedition_Requirement.FleetLevel) {
                  ...
                  $24.levelCount = new Data_Maybe.Just(fleetReq.value0);
                  return $24;
              };
              if (fleetReq instanceof KanColle_Expedition_Requirement.FleetDrum) {
                  ...
                  $28.drumCount = new Data_Maybe.Just(fleetReq.value0);
                  return $28;
              };
              if (fleetReq instanceof KanColle_Expedition_Requirement.FleetShipWithDrum) {
                  var $32 = {};
                  for (var $33 in p) {
                      if ({}.hasOwnProperty.call(p, $33)) {
                          $32[$33] = p[$33];
                      };
                  };
                  $32.drumCarrierCount = new Data_Maybe.Just(fleetReq.value0);
                  return $32;
              };
              if (fleetReq instanceof KanColle_Expedition_Requirement.FleetSTypeCount) {
                  ...
                  var $36 = {};
                  for (var $37 in p) {
                      if ({}.hasOwnProperty.call(p, $37)) {
                          $36[$37] = p[$37];
                      };
                  };
                  $36.fleetSType = Data_Array.snoc(p.fleetSType)(req);
                  return $36;
              };
              if (fleetReq instanceof KanColle_Expedition_Requirement.FleetShipCount) {
                  var $41 = {};
                  for (var $42 in p) {
                      if ({}.hasOwnProperty.call(p, $42)) {
                          $41[$42] = p[$42];
                      };
                  };
                  $41.shipCount = fleetReq.value0;
                  return $41;
              };
  ...
  var getExpeditionRequirementObject = function ($49) {
      return requirementPackToObj(getExpeditionRequirementPack($49));
  };
  var checkWithRequirementPack = function (req) {
      return function (fleet) {
          var count = function (pred) {
              return function ($50) {
                  return Data_Array.length(Data_Array.filter(pred)($50));
              };
          };
          ...
          var $45 = Data_Array.uncons(fleet);
          if ($45 instanceof Data_Maybe.Just) {
              var flagShipLevel = $45.value0.head.level >= req.flagShipLevel;
              return {
                  flagShipLevel: flagShipLevel, 
                  shipCount: Data_Array.length(fleet) >= req.shipCount, 
                  flagShipTypeOf: Data_Functor.map(Data_Maybe.functorMaybe)(checkShipType($45.value0.head.stype))(req.flagShipTypeOf), 
          ...
          throw new Error("Failed pattern match at KanColle.Expedition.RequirementObject line 116, column 38 - line 146, column 11: " + [ $45.constructor.name ]);
      };
  };
...
(function(exports) {
  ...
  var generateRemodelGroup = function (rim) {
      return function (originId) {
          ...
          var ri = Data_Maybe.fromJust()(getRI(originId));
          var findLoop = function (__copy_visited) {
              return function (__copy_cur) {
                  var visited = __copy_visited;
                  var cur = __copy_cur;
                  tco: while (true) {
                      var $12 = Data_List.elemIndex(Data_Eq.eqInt)(cur)(visited);
                      if ($12 instanceof Data_Maybe.Nothing) {
                          ...
                          if ($13 instanceof Data_Maybe.Just) {
                              visited = newVisited;
                              cur = $13.value0.shipIdTo;
                              continue tco;
                          };
                          throw new Error("Failed pattern match at KanColle.Remodel line 138, column 14 - line 140, column 59: " + [ $13.constructor.name ]);
                      };
                      if ($12 instanceof Data_Maybe.Just) {
                          return visited;
                      };
                      throw new Error("Failed pattern match at KanColle.Remodel line 135, column 28 - line 141, column 26: " + [ $12.constructor.name ]);
                  };
              };
          };
          var groupL$prime = findLoop(Data_List_Types.Nil.value)(originId);
          var group = Data_Array.reverse(listToArray(groupL$prime));
          var finalFormsL$prime = findLoop(Data_List_Types.Nil.value)(Data_List_Partial.head()(groupL$prime));
              ...
              return function (upgrade) {
                  ...
                  var modifyRemodel = function (ri) {
                      ...
                      return optTrace(check)(function (v) {
                          var $20 = {};
                          for (var $21 in ri) {
                              if ({}.hasOwnProperty.call(ri, $21)) {
                                  $20[$21] = ri[$21];
                              };
                          };
                          $20.catapult = upgrade.api_catapult_count;
                          $20.blueprint = upgrade.api_drawing_count;
                          return $20;
                      });
                  };
  ...
  var fromMstShip = function (ms) {
      ...
      if (Data_Boolean.otherwise) {
          var result = {
              ...
              shipIdTo: Data_Maybe.fromJust()(Data_Int.fromString(ms.api_aftershipid)), 
          ...
          return new Data_Maybe.Just((function () {
              var $25 = {};
              for (var $26 in result) {
                  if ({}.hasOwnProperty.call(result, $26)) {
                      $25[$26] = result[$26];
                  };
              };
              $25.devmat = calcDevMat(result.steel);
              return $25;
          })());
      };
  ...
  var collectRemodelInfo1 = function (mstShips) {
      var remodelInfoAr = Data_Foldable.foldMap(Data_Foldable.foldableArray)(Data_Monoid.monoidArray)(function ($28) {
          return maybeToArray(fromMstShip($28));
      })(mstShips);
          ...
          return function (curHp) {
              return function (maxHp) {
                  ...
                  var repairTime = (function () {
                      ...
                      if (!$9) {
                          var a = (Data_Int.floor($$Math.sqrt(Data_Int.toNumber(v1 - 11 | 0))) * 10 | 0) + 50 | 0;
  ...
  var facilityInSec = function (s) {
      return function (lvl) {
          return function (curHp) {
              return function (maxHp) {
                  var m20 = 20 * 60 | 0;
                  var facilitySlowestTime = m20 * (maxHp - curHp | 0) | 0;
